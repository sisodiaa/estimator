...
ActiveRecord::Schema.define(version: 2018_07_24_165306) do
  ...
  create_table "belts", force: :cascade do |t|
    ...
    t.integer "minor_join_charge"
    t.integer "major_join_charge"
    t.integer "rounding_off"
