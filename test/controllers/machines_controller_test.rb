...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { make: @machine.make, model: @machine.model, section: @machine.section, sub_section: @machine.sub_section } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { make: @machine.make, model: @machine.model, section: @machine.section, sub_section: @machine.sub_section } }
